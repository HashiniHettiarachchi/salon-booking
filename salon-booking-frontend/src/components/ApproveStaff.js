...
const ApproveStaff = () => {
  ...
  const fetchPendingStaff = async () => {
    try {
      ...
      setError("Failed to load pending staff. " + (err.response?.data?.message || err.message));
    }
  };

  // Fetch approved staff members
  ...
  const handleApprove = async (staffId, staffName) => {
    ...
    try {
      ...
      setError("Failed to approve staff. " + (err.response?.data?.message || err.message));
            ...
            <table className="staff-table">
              <thead>
                <tr>
                  ...
                  <th>Select Category/Specialization</th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
